<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
        ...
        <form class="form-inline ml-3 d-none d-lg-flex" action="index.php" method="GET" style="max-width: 300px;">
        ...
        <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
            ...
            <ul class="navbar-nav ml-auto">
                <form class="form-inline my-2 my-lg-0 d-lg-none" action="index.php" method="GET" style="max-width: 300px;">
                    <div class="input-group input-group-sm">
                        <input class="form-control" type="search" placeholder="Suchen" aria-label="Suchen" name="query">
                        <div class="input-group-append">
                            <button class="btn btn-outline-light" type="submit">
