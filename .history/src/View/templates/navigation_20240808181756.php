<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
        <a class="navbar-brand" href="index.php">
            <img src="../assets/images/Gruppenlogo_rund.png" alt="Webshop Logo" style="height: 50px;">
        </a>
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="user_profile.php">
                        <img src="../assets/images/<?php echo htmlspecialchars($user['profile_image'] ?: 'default_profile.png'); ?>" alt="Profil" style="height: 24px; border-radius: 50%;">
                    </a>
                    <li class="nav-item">
