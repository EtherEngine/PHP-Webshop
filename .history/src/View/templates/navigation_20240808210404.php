                ...
                <?php if (isset($_SESSION['user_id'])): ?>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img src="../assets/images/<?php echo !empty($user['profile_image']) ? 'images_user/' . htmlspecialchars($user['profile_image']) : 'profil_icon_w.png'; ?>" alt="Profil" class="rounded-circle" style="height: 24px; width: 24px;">
                        </a>
