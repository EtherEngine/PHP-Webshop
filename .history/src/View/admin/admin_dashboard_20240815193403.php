...
<body>
    <div class="container mt-5">
        ...
        <ul>
            ...
            <li><strong>Gesamtumsatz:</strong> <?php echo number_format($totalRevenue, 2, ',', '.'); ?> €</li>
            <li><strong>Gesamtmenge der verkauften Produkte:</strong> <?php echo $totalQuantity; ?></li>
            <li><strong>Durchschnittlicher Bestellwert:</strong>
                <?php echo number_format($averageOrderValue, 2, ',', '.'); ?> €</li>
            <li><strong>Median des Bestellwerts:</strong> <?php echo number_format($medianOrderValue, 2, ',', '.'); ?> €
            </li>
        </ul>
