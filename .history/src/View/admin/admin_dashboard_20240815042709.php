...
<head>
    ...
    <style>
        ...
        /* Styling the table for orders and user management */
        .dashboard-table {
            width: 100%;
            margin-bottom: 30px;
...
<body>
    ...
    <div class="container dashboard-container">
        ...
        <!-- Example table for displaying orders or user management -->
        <div class="dashboard-section">
            ...
            <table class="dashboard-table">
                ...
                <tbody>
                    ...
                    <!-- Weitere Bestellungen können hier aufgelistet werden -->
                </tbody>
            </table>
        </div>
    </div>
