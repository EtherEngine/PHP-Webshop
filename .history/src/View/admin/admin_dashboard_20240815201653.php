...
// Benutzeraktivitäten für Timeline
$sqlUserActivity = "SELECT activity_type, activity_details, activity_date FROM user_activities ORDER BY activity_date DESC";
$stmt = $pdo->prepare($sqlUserActivity);
$stmt->execute();
