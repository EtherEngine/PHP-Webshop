...
foreach ($cart as $item) {
    ...
    $total_weight += $item['weight'] * $item['quantity']; // Gewicht berechnen
}

// Funktion zur Berechnung der Versandkosten
function calculate_shipping_cost($method, $weight, $country)
{
    $base_cost = 0;
...
$shipping_cost = calculate_shipping_cost($shipping_method, $total_weight, $user_data['country']);
