...
<body>
    ...
    <div class="container">
        <h1 class="text-center">Über uns: Visionary Minds</h1>
        <p class="text-center">Informationen über unser Unternehmen.</p>
        <div class="content">
            ...
            <p><strong>Telefon:</strong> +49 89 1234567<br> <strong>E-Mail:</strong> info@visionaryminds.de<br>
                <strong>Website:</strong> www.visionaryminds.de</p>
        </div>
    </div>
