                ...
                <div class="col-md-4 mb-4">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <a href="product_detail.php?id=<?php echo $product['id']; ?>" class="btn btn-custom">Mehr
                                erfahren</a>
                            <?php if (isset($_SESSION['user_id'])): ?>
                                <?php if (isset($_SESSION['cart'][$product['id']])): ?>
                                    <button class="btn btn-success" disabled>Zum Warenkorb hinzugefügt</button>
                                <?php else: ?>
                                    <a href="index.php?add_to_cart=<?php echo $product['id']; ?>" class="btn btn-cart"><i
                                            class="fas fa-plus"></i></a>
                                <?php endif; ?>
                            <?php else: ?>
                                <a href="login.php" class="btn btn-custom">Einloggen, um hinzuzufügen</a>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
