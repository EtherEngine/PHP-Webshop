    ...
    if (!validate_csrf_token($csrf_token)) {
        ...
        if ($user) {
            ...
            try {
                ...
                $welcome_message = 'Willkommen, ' . htmlspecialchars($username, ENT_QUOTES, 'UTF-8') . '! Du wirst in 5 Sekunden weitergeleitet.';
                $redirect = true; // Set the redirection flag to true
            } catch (PDOException $e) {
                $error_message = 'Datenbankfehler: ' . htmlspecialchars($e->getMessage(), ENT_QUOTES, 'UTF-8');
            }
        }
    }
}

// If the user should be redirected, redirect them immediately
if ($redirect) {
        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                ...
                <?php if ($welcome_message): ?>
                    <div class="alert alert-success"><?php echo htmlspecialchars($welcome_message, ENT_QUOTES, 'UTF-8'); ?>
                    </div>
