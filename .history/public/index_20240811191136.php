...
// Standardmäßig Englisch setzen, falls keine Sprache in der Session gesetzt ist
if (!isset($_SESSION['lang'])) {
    $_SESSION['lang'] = 'en'; // Standardmäßig Englisch
}

// Überprüfen, ob eine Sprachänderung angefordert wurde
if (isset($_GET['lang'])) {
    $lang = $_GET['lang'];
    if (in_array($lang, ['en', 'de', 'es'])) { // Nur erlaubte Sprachen
        $_SESSION['lang'] = $lang;
    }
}

// Sprachdatei basierend auf der Session laden
$lang_file = __DIR__ . "/../languages/" . $_SESSION['lang'] . ".php";
if (file_exists($lang_file)) {
    include $lang_file;
} else {
    include __DIR__ . "/../languages/en.php"; // Fallback zu Englisch
}
    ...
    <div class="search-bar">
        <form class="form-inline" action="index.php" method="GET">
            <div class="input-group input-group-lg">
                <input class="form-control" type="search" placeholder="<?php echo $lang['search_placeholder']; ?>"
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <div class="quantity-popup">
                                ...
                                <button class="add-quantity-btn"><?php echo $lang['add_to_cart']; ?></button>
                            </div>
                        ...
                        $.ajax({
                            ...
                            success: function (response) {
                                ...
                                if (data.status === 'success') {
                                    ...
                                    $('#alert-placeholder').html('<div class="alert alert-success">' + data.quantity + ' <?php echo $lang['product_added']; ?>!</div>');
                                    setTimeout(function () {
