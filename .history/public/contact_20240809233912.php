...
<head>
    ...
    <style>
        ...
        /* Verstecke das Coze-Icon standardmäßig */
        #coze-icon {
            display: none;
        }
    </style>
...
<body>
    ...
    <script>
        const cozeIcon = document.querySelector('#coze-icon');
        ...
        // Coze-Button Klick-Handler
        document.querySelector('.coze-button').addEventListener('click', function (e) {
            e.preventDefault();
            CozeWebSDK.WebChatClient.open();
            cozeIcon.style.display = 'block';
        });

        // Coze-Chat-Event-Handler
        CozeWebSDK.WebChatClient.on('close', function () {
            cozeIcon.style.display = 'none';
        });

        // Icon-Logout-Event-Handler
