...
<head>
    ...
    <style>
        :root {
            --btn-bg-color: #888;
            /* Dezenteres Grau für die Hintergrundfarbe */
            --btn-hover-bg-color: #aaa;
            /* Etwas helleres Grau beim Hover */
            --btn-color: #fff;
            /* Weißer Text */
        ...
        .quantity-btn {
            ...
            box-shadow: none;
            /* Kein Schatten für ein dezenteres Aussehen */
        ...
        .quantity-btn:active {
            background-color: var(--btn-hover-bg-color);
            transform: none;
            /* Keine Transformation beim Klicken, um die Schlichtheit zu wahren */
        }
