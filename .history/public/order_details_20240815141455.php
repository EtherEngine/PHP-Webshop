            ...
            <table class="table">
                ...
                <tfoot>
                    ...
                    <tr>
                        ...
                        <td id="total_with_shipping"><?php echo number_format($total_with_shipping, 2, ',', '.'); ?> €</td>
                    </tr>
                </tfoot>
            </table>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#shipping_method').change(function () {
                ...
                // AJAX-Request zur Berechnung der Versandkosten
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        $('#total_with_shipping').text(totalWithShipping.toFixed(2).replace('.', ',') + ' €');
                    },
