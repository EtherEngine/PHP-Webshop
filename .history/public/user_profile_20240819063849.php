...
// Prepare a SQL statement to retrieve user details from the database
...
// Execute the statement with the user's ID as a parameter
$stmt->execute([$user_id]);

// Fetch the user's details as an associative array
$user = $stmt->fetch(PDO::FETCH_ASSOC);

// Set the profile image to the user's profile image, or use a default image if not available
