...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($password !== $confirm_password) {
        ...
        if ($user) {
            ...
            $welcome_message = 'Registrierung erfolgreich, weiterleitung in...';
            $redirect = true;
        }
    }
}
            ...
            <div class="col-md-6">
                ...
                <?php if ($welcome_message): ?>
                    <div class="centered-message">
                        <div class="message"><?php echo htmlspecialchars($welcome_message); ?></div>
                ...
                <?php endif; ?>
                <form action="register.php" method="POST" id="registration-form" <?php echo $redirect ? 'style="display:none;"' : ''; ?>>
