...
if (isset($_GET['id']) && is_numeric($_GET['id'])) {
    ...
    // Ähnliche Produkte abrufen basierend auf der gleichen Kategorie
    $similarStmt = $pdo->prepare('SELECT * FROM products WHERE category = ? AND id != ? LIMIT 4');
    $similarStmt->execute([$product['category'], $id]);
